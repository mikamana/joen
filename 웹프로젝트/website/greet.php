...
<section class="greet_section">
  <p class="emphasis serif">
    정보화 시대에 <em class="point">빠른 정보를 원하는 우리들에게</em> 인터넷은<br>
    하나의 <em class="point">거대한 생활공간</em>이 되었습니다.
  </p>
  <p class="subinfo">
  ...
  <figure>
    <div>
      <img src="./img/sub1/about-01.jpg" alt="콘텐츠1이미지">
    </div>
    <div>
      <img src="./img/sub1/about-02.jpg" alt="콘텐츠2이미지">
    </div>
  </figure>
  <p class="emphasis serif">
    그만큼 홈페이지는 <em class="point">기업활동의 중요한 요소</em>가 되었고 매출과<br>
    <em class="point">이미지 향상의 가장 영향력이있는 매체</em>가 되었습니다.
  </p>
  <p class="subinfo">
